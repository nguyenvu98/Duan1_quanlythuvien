 ...
 * @author user
 */
public class FormManHinhChao extends javax.swing.JDialog {

    /**
     * Creates new form FormManHinhChao
     */
    public FormManHinhChao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/Librarybook/icon/library3.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormManHinhChao dialog = new FormManHinhChao(new javax.swing.JFrame(), true);
